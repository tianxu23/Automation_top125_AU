...
os.chdir('C:/Users/tianxu/Documents/top125/ExcelAU')
...
if (end_dt1 < current_date - Day and end_dt2 < current_date - Day and end_dt3 < current_date - Day):
    ...
    p = subprocess.Popen('\"C:/Program Files (x86)/Microsoft Office/Office16/excel.exe\" \"C:/Users/tianxu/Documents/top125/ExcelAU/New_driver2.xlsm\"', shell=True, stdout = subprocess.PIPE)
    stdout, stderr = p.communicate()
    print stdout
    print 'Update Finished: AU'
    time.sleep(10)
    # print 'Ending time: ' + time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())
    print 'Send eMail'
    execfile('EmailSender_Traffic1_AU.py')
    conn.close()
    exit(0)
